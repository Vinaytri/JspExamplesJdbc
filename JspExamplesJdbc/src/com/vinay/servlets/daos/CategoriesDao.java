package com.vinay.servlets.daos;
...
import com.vinay.servlets.pojos.Categories;
import com.vinay.servlets.utilities.ConnectionPool;
...
public class CategoriesDao {
	...
	public static void main(String args[]) {
		...
		/*
		 * CategoriesDaos dc = new CategoriesDaos(); Categories obj = new
		 * Categories("electronics", "computer"); dc.create(obj);
		 */

		/*
		 * Categories category = new Categories(224, "electronics", "laptop");
		 * CategoriesDaos cd = new CategoriesDaos(); cd.edit(category);
		 */
